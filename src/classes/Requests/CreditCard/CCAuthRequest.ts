...
export default class CCAuthRequest extends CardknoxRequest{
    readonly xCommand: string = "cc:authonly";
    ...
    xHotelCheckInDate: string | undefined;
    xHotelCheckOutDate: string | undefined;
    xAllowPartialAuth: string | undefined;
    xAutoRentalPickupDate: string | undefined;
    xAutoRentalPickupTime: string | undefined;
    xAutoRentalReturnDate: string | undefined;
    xAutoRentalReturnTime: string | undefined;
    xRxAmount: string | undefined;
    xDentalAmount: string | undefined;
    xVisionAmount: string | undefined;
    xTransitAmount: string | undefined;
    xCopayAmount: string | undefined;
    xClinicalAmount: string | undefined;
